...
typedef Widget ItemBuilders<T>(List<T> list, int position);


/// 支持下拉刷新&上拉加载更多的 ListView
/// 
class ListViewWidget<T> extends StatefulWidget {
  PageRequest<T> pageRequest;
  ItemBuilders<T> itemBuilder;
  int pageSize;
  int page;
  bool enableLoadmore;
  bool enableRefresh;
  ...
  ListViewWidget(this.pageRequest, this.itemBuilder,
      {this.pageSize = 20,
      this.page = 0,
  ...
  @override
  State<ListViewWidget> createState() => new _ListViewWidgetState<T>();
